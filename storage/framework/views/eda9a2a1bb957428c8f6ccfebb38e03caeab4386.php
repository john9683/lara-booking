            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">Выбор отеля</a>
                    <?php else: ?>
...
<?php /**PATH /var/www/project/resources/views/welcome.blade.php ENDPATH**/ ?>